...
#define IDT_IRQ_PIT_SYSTEM_TIMER 0x20
#define IDT_IRQ_KEYBOARD_CONTROLLER 0x21
#define IDT_IRQ_REAL_TIME_CLOCK 0x28
#define IDT_IRQ_ACPI 0x29
#define IDT_IRQ_MOUSE 0x2c
